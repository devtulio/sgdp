...
//
// O banco é um diretório temporário novo a cada execução (SGDP_DATA_DIR), como
// nos testes: a captura NUNCA enxerga o sgdp.db real. Isso é o que garante que
...
const dataDir = mkdtempSync(join(tmpdir(), 'sgdp-shots-'));
const port = 3259;   // porta propria: nao conflita com a suite E2E (3050)
